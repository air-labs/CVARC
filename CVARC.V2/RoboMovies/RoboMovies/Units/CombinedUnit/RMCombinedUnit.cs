...
namespace CVARC.V2
{
    public class RMCombinedUnit : CombinedUnit
    {
        ...
        {
            return actor.World.IdGenerator.GetAllPairs()
                .Where(z => z.Item1 is RMObject)
                .Select(z => new Tuple<RMObject, string>((RMObject)z.Item1, z.Item2))
        ...
        {
            return Math.Abs(bot.X - stair.X) < 20 &&
                   Math.Abs(bot.Y - stair.Y) < 50;
        }
        ...
        public double GoStair(IActor actor)
        {
            ...
            if (id != null)
            {
                ...
                actor.World.Engine.Attach(actor.ObjectId, "stair", new Frame3D(0, 0, 0));
