					...
					_rootBody.Add(new Core.Box
					              	{
                                        ...
                                        Top = PlaneImageBrush.FromResource(() => CVARC.Engine.KR.Properties.Resources.untitled),
                                        Bottom = PlaneImageBrush.FromResource(() => CVARC.Engine.KR.Properties.Resources.untitled),
					              		Location = GetRandomFrame()
					              	});
					_rootBody.Add(new Body
					              	{
                                        Model = Model.FromResource(() => CVARC.Engine.KR.Properties.Resources.totem),
					              		Location = GetRandomFrame()
					              	});
