...
namespace CVARC.Tutorial
{
    public class KeyboardController
    {
        public Command GetCommand(Keys keyData)
        {
            ...
            {
                case Keys.W:
                    return new Command {Time = 10, Move = 100, RobotId = 0};
                case Keys.S:
                    return new Command {Time = 10, Move = -100, RobotId = 0};
                case Keys.A:
                    return new Command {Time = 10, Angle = Angle.FromGrad(90), RobotId = 0};
                case Keys.D:
                    return new Command {Time = 10, Angle = Angle.FromGrad(-90), RobotId = 0};
                case Keys.Q:
                ...
                case Keys.NumPad8:
                    return new Command {Move = 100, RobotId = 1};
                case Keys.NumPad5:
                    return new Command {Move = -100, RobotId = 1};
                case Keys.NumPad4:
                    return new Command {Angle = Angle.FromGrad(90), RobotId = 1};
                case Keys.NumPad6:
                    return new Command {Angle = Angle.FromGrad(-90), RobotId = 1};
                case Keys.NumPad7:
